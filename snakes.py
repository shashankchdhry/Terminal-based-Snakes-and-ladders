import termcolor as tc, random, time
...
def list_players(numbers):
    ...
    def check_player(players,text):
        ...
        while True:
            ...
            if name not in players and name != "computer" and name.isalpha():
                return name
            elif name == "computer":
                print("Sorry, you can't have that name...\n")
            elif not(name.isalpha()):
                print("I am sorry, thats not a name !!\n")
            else:
    ...
    if numbers == 1:
        players["computer"] = [beeds[1],1]
        print("Playing with Computer...\nIt's beed is: %s :" %(tc.colored(beeds[1],"blue",None,["bold"])))
    return players
...
def dice(chance):
    ...
    if chance == 4 or chance == 6 or chance == 5:
        ...
        print(tc.colored("*".rjust(7),"yellow",None,["bold"]),end="")
    elif chance == 1:
        print("".rjust(7),end="")
    print("|")
    ...
    if chance != 4 and chance != 2:
        ...
        if chance == 5 or chance == 6:
            ...
            print(tc.colored("*".ljust(7),"yellow",None,["bold"]),end="")
        print("|")
...
def play_game():
    ...
    counter = 0
    # display the symbol meanings
    print("\n∫ is for snakes.\n%s is for ladders." %(tc.colored("†","yellow",None,["bold"])))
    ...
    while is_gameover(players)[0]:
        ...
        # check if it's computer or player
        if crrnt_plyr == "computer":
            print("It's %s's %s chance" %(crrnt_plyr.capitalize(),crrnt_plyr_clr))
            roll = "roll"
        else:
            roll = input("It's %s's %s chance:\nroll the DICE: " %(crrnt_plyr.capitalize(),crrnt_plyr_clr)).lower().strip()
        # roll the dice
        if roll == "roll".lower().strip():
